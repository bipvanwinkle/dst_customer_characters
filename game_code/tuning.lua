...
function Tune(overrides)
  ...
  TUNING =
  {
    ...
    OCEANFISHING_LURE =
    {
      ...
      SPOILED_FOOD = { charm = 0.1, reel_charm = -0.3, radius = 2.0, style = "rot",
        timeofday = { day = 1, dusk = 1, night = 1 }, dist_max = 2 },

      SEED  = { charm = 0.2, reel_charm = -0.3, radius = 3.0, style = "seed",
        timeofday = { day = 1, dusk = 1, night = 1 },
        dist_max = 1 },
      BERRY = { charm = 0.3, reel_charm = -0.3, radius = 3.0, style = "berry",
        timeofday = { day = 1, dusk = 1, night = 1 },
        dist_max = 1 },
      FIG   = { charm = 0.5, reel_charm = -0.3, radius = 4.0, style = "berry",
        timeofday = { day = 1, dusk = 1, night = 1 },
        dist_max = 1 },

      SPOON_DAY   = { charm = 0.2, reel_charm = 0.3, radius = 4.0, style = "spoon",
        timeofday = { day = 1.0, dusk = 0.3, night = 0.3 }, dist_max = 1 },
      SPOON_DUSK  = { charm = 0.2, reel_charm = 0.3, radius = 4.0, style = "spoon",
        timeofday = { day = 0.3, dusk = 1.0, night = 0.3 }, dist_max = 1 },
      SPOON_NIGHT = { charm = 0.2, reel_charm = 0.3, radius = 4.0, style = "spoon",
        timeofday = { day = 0.3, dusk = 0.3, night = 1.0 }, dist_max = 1 },
      SPOON_SPORK = { charm = 0.2, reel_charm = 0.3, radius = 4.0, style = "spoon",
        timeofday = { day = 1.0, dusk = 1.0, night = 1.0 }, dist_max = 1 },

      SPINNERBAIT_DAY   = { charm = 0.4, reel_charm = 0.4, radius = 5.0, style = "spinnerbait",
        timeofday = { day = 1.0, dusk = 0.3, night = 0.3 }, dist_max = 2 },
      SPINNERBAIT_DUSK  = { charm = 0.4, reel_charm = 0.4, radius = 5.0, style = "spinnerbait",
        timeofday = { day = 0.3, dusk = 1.0, night = 0.3 }, dist_max = 2 },
      SPINNERBAIT_NIGHT = { charm = 0.4, reel_charm = 0.4, radius = 5.0, style = "spinnerbait",
        timeofday = { day = 0.3, dusk = 0.3, night = 1.0 }, dist_max = 2 },

      SPECIAL_RAIN   = { charm = 0.3, reel_charm = 0.5, radius = 5.0, style = "special",
        timeofday = { day = 1, dusk = 1, night = 1 }, dist_max = 1,
        weather = { default = 0.0, raining = 1.0, snowing = 0.0 } },
      SPECIAL_SNOW   = { charm = 0.3, reel_charm = 0.5, radius = 5.0, style = "special",
        timeofday = { day = 1, dusk = 1, night = 1 }, dist_max = 1,
        weather = { default = 0.0, raining = 0.0, snowing = 1.0 } },
      SPECIAL_DROWSY = { charm = 0.1, reel_charm = 0.3, radius = 3.0, style = "special",
        timeofday = { day = 1, dusk = 1, night = 1 }, dist_max = 1, stamina_drain = 1.0 },
      SPECIAL_HEAVY  = { charm = 0.5, reel_charm = 0.0, radius = 5.0, style = "special",
        timeofday = { day = 1, dusk = 1, night = 1 }, dist_max = 1, },

      SPOON_WIP       = { charm = 0.2, reel_charm = 0.3, radius = 4.0, style = "spoon",
        timeofday = { day = 0.0, dusk = 0.0, night = 0.0 } },
      SPINNERBAIT_WIP = { charm = 0.2, reel_charm = 0.3, radius = 4.0, style = "spinnerbait",
        timeofday = { day = 0.0, dusk = 0.0, night = 0.0 } },
    },
    ...
    {
      SMALL_VEGGIE = { hook = 0.25, special = 1.00, rot = 1.00, seed = 1.50, berry = 1.50, spoon = 0.00,
        spinnerbait = 0.00, insect = 0.00 },
      VEGGIE       = { hook = 0.25, special = 1.00, rot = 0.50, seed = 1.50, berry = 1.50, spoon = 0.50,
        spinnerbait = 0.00, insect = 0.00 },
      SMALL_OMNI   = { hook = 0.25, special = 1.00, rot = 1.00, seed = 1.00, berry = 1.00, spoon = 1.00,
        spinnerbait = 0.00, insect = 1.00 },
      OMNI         = { hook = 0.25, special = 1.00, rot = 0.50, seed = 0.25, berry = 1.00, spoon = 1.00,
        spinnerbait = 1.00, insect = 1.00 },
      SMALL_MEAT   = { hook = 0.25, special = 1.00, rot = 1.00, seed = 0.00, berry = 0.00, spoon = 1.00,
        spinnerbait = 0.00, insect = 1.00 },
      MEAT         = { hook = 0.25, special = 1.00, rot = 0.50, seed = 0.00, berry = 0.00, spoon = 1.00,
        spinnerbait = 1.00, insect = 1.00 },
      WOBSTER      = { hook = 0.25, special = 1.00, rot = 1.00, seed = 0.25, berry = 1.00, spoon = 1.00,
        spinnerbait = 1.00, insect = 1.00 },
      BERRY        = { hook = 0.25, special = 1.00, rot = 0.50, seed = 0.50, berry = 2.00, spoon = 0.50,
        spinnerbait = 0.00, insect = 0.00 },
    },
    ...
    GAMEMODE_STARTING_ITEMS =
    {
      DEFAULT =
      {
        ...
        WES = { "balloons_empty" },
        WAXWELL = { "waxwelljournal", "nightmarefuel", "nightmarefuel", "nightmarefuel", "nightmarefuel", "nightmarefuel",
          "nightmarefuel" },
        WOODIE = { "lucy" },
    ...
    {
      autumn = { "cutgrass", "cutgrass", "cutgrass", "cutgrass", "cutgrass", "twigs", "twigs", "twigs", "twigs", "twigs",
        "flint" },
      winter = { "cutgrass", "cutgrass", "cutgrass", "cutgrass", "cutgrass", "twigs", "twigs", "twigs", "twigs", "twigs",
        "flint" },
      spring = { "cutgrass", "cutgrass", "cutgrass", "cutgrass", "cutgrass", "twigs", "twigs", "twigs", "twigs", "twigs",
        "flint" },
      summer = { "cutgrass", "cutgrass", "cutgrass", "cutgrass", "cutgrass", "twigs", "twigs", "twigs", "twigs", "twigs",
        "flint" },
    },
